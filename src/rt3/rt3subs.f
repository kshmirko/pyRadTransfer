      SUBROUTINE RT3(NSTOKES, NUMMU, AZIORDER, MU_VALUES,
...
C      CALL USER_INPUT (NSTOKES, NUMMU, AZIORDER, MU_VALUES,
C     .                    SRC_CODE, LAYER_FILE, OUT_FILE,
C     .                    QUAD_TYPE, DELTAM, DIRECT_FLUX, DIRECT_MU,
C     .                    GROUND_TEMP, GROUND_TYPE,
C     .                    GROUND_ALBEDO, GROUND_INDEX,
C     .                    SKY_TEMP, WAVELENGTH, UNITS, OUTPOL,
C     .                    NOUTLEVELS, OUTLEVELS, NUMAZIMUTHS)
